...
endmodule //s_mem_altsyncram1

//synthesis_resources = M10K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  s_mem_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	s_mem_altsyncram	s_mem_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
